  ...
  public function downloadCsv() {
    ...
    foreach ($users as $user) {
      ...
      if (empty($personal_data_nodes)) {
        // Skip if no personal data found.
        continue;
      }
      ...
      if (empty($research_data_nodes)) {
        // Skip if no research data found.
        continue;
      }
      ...
      if (empty($interest_nids)) {
        // Skip if no interest nodes found.
        continue;
      }
      ...
      // Host institution.
        $host_institution,
      // Research Manager.
        $research_manager_name,
      // Email of the Research manager.
        $research_manager_email,
      // Submission Date (personal_data creation date)
        $submission_date,
      ];
