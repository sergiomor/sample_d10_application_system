...
/**
 * Form handler for researcher expressions of interest.
 *
 * This form provides functionality to:
 * - Collect researcher contact information
 * - Validate candidate limits
 * - Send notification emails
 * - Record interest expressions
 */ ExpressionsInterest extends FormBase {
...
/**
 * Handles form submission for researcher interest expressions.
 *
 * Processes the form submission by:
 * - Validating researcher email and candidate limits
 * - Sending notification emails to researchers
 * - Recording the expression of interest
 *
 * @param array $form
 *   The form array.
  ...
  public function submitForm(
    ...
    if (count($ir_users) > 0) {
      ...
      $result = $mailManager->mail($module, $key, $to, $language_code, $params,
            $from, $send_now);
      // $result = $mailManager->mail($module, $key, $copia, 
      // $language_code, $params, $from, $send_now);
