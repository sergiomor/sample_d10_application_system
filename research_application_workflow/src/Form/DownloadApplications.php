      ...
      if ($zip->open($zip_file_uri, \ZipArchive::CREATE | \ZipArchive::OVERWRITE) === TRUE) {
        ...
        foreach ($directories_to_include as $directory_path) {
          ...
          if (strpos($directory_path, '/') !== FALSE) {
            ...
            $file_system->prepareDirectory($parent_dir, FileSystemInterface::CREATE_DIRECTORY | FileSystemInterface::MODIFY_PERMISSIONS);
          }
          ...
          foreach ($files as $file) {
            ...
            // For the rankings/approved directory, 
            // use "rankings" as the directory name in the zip.
