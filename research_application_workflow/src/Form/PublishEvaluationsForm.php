  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($terms as $term) {
      ...
      if ($term_obj->hasField('field_ranking_pdf') && $term_obj->get('field_ranking_pdf')->isEmpty()) {
        // Check if there are candidates with role 'candidato_enviado' who have chosen this term in their research_data
        ...
        if (!empty($candidato_enviado_uids)) {
          // Find research_data nodes that belong to candidato_enviado users and reference this term
